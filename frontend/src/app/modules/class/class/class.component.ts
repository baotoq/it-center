...
export class ClassComponent implements OnInit {
  ...
  private createForm() {
    this.classForm = this.formBuilder.group({
      ...
      startedAt: [this.formatDate2(this.class.startedAt), [Validators.required, Validators.pattern(/\d{4}-\d{2}-\d{2}/), Validators.maxLength(10)]],
      endedAt: [this.formatDate2(this.class.endedAt), [Validators.required, Validators.pattern(/\d{4}-\d{2}-\d{2}/), Validators.maxLength(10)]],
